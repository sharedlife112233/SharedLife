        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatMessages_DonorRequests_DonorRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_DonorRequestId",
                table: "ChatMessages",
                column: "DonorRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_DonorRequestId_CreatedAt",
                table: "ChatMessages",
                columns: new[] { "DonorRequestId", "CreatedAt" });
